...
export const rejectCandidate = (offerId, companyId, recommendationId) => {
    return axiosInstance.post(`/offers/candidates/reject-candidate/${offerId}/${companyId}/${recommendationId}`)
}