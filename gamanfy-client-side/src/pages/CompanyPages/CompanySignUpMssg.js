        ...
        <div className='container-fluid div-wrapper'>
            ...
            {!infoSent ?
                <div className='card card-signupMssg col-lg-4 mx-auto'>
                    <img className='tick-logo d-block mx-auto' src='/tick_logo.png' alt='logo-gamanfy' />

                    <div>
                        <p className=' card-body p-signup text-center' style={{ fontWeight: '700' }}>Acabamos de crear tu cuenta</p>
                        <p className=' dar-body p-signup text-center'> Para empezar a encontrar el mejor talento, verifica tu bandeja de entrada y haz click en el link que te hemos enviado para completar la validación.</p>
                    </div>
