...
export const HomePage = (customProps) => {        
    return (
        <div>
            ...
            <p className='p-inputs' style={{textAlign:'justify', margin:'3em 1em 1em 1em'}}>Estamos encantados de que formes parte de la comunidad Empresa de Gamanfy.</p>
            <p className='p-inputs' style={{textAlign:'justify', margin:'0 1em 1em 1em'}}>Gamanfy es la primera plataforma de selección de personal 2.0 que combina las nuevas tecnologías con un programa de referenciadores de candidatos externo elaborado por profesionales e influencers de talento ambos expertos en su sector</p>
            ...
            <p className='p-inputs p-homePage-company' >Si conoces a una persona con grandes habilidades que no hayas podido incorporar en tu empresa y quieres ayudarla a impulsar su carrera, inscríbela en nuestra base de datos y nosotros le recomendaremos ofertas que se ajusten a su perfil.</p>
